...
function CheckerBoard({ board, squareClickHandler, makeMove, socketID, vsPerson, myTurn, userColor, legalMoves, chosenPiece, resetFunc }) {
                ...
                {board.map((row, rowIndex) =>
                    row.map((square, columnIndex) => (
                        <Square
                            ...
                            chosenPiece={chosenPiece && chosenPiece[0] === rowIndex && chosenPiece[1] === columnIndex}
                            userColor={userColor}
                            legalMove={legalMoves.some((move) => move[0] === rowIndex && move[1] === columnIndex)}
                            squareClickHandler={() => squareClickHandler(rowIndex, columnIndex, square)}
