...
export default function AccountForm() {
    ...
    const sendUserDataToServer = async (bodyData) => {
        try {
            ...
            if (response.data.modifiedCount == 1) notify('success', 'Your personal details  has been changed');
    ...
    const sendPasswordDataToServer = async (bodyData) => {
        try {
            ...
            if (error.response.status === 401) notify('error', 'Your password has not been changed. Try again');
    ...
    if (!info._id) {
        let imgSrc = 'https://img.pikbest.com/png-images/20190918/cartoon-snail-loading-loading-gif-animation_2734139.png!bw700';
