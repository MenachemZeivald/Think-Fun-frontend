                ...
                <>
                    ...
                    <ChatBodyStyle>
                        {messages.map((message, i) => {
                            return <ChatBubbleStyle isSender={message.isSender}>{message.text}</ChatBubbleStyle>;
                        })}
                    </ChatBodyStyle>
                    <InputFieldStyle value={input} ref={divRef} onChange={(e) => setInput(e.target.value)} placeholder='Type your message here...' onKeyPress={sendMessage} />
