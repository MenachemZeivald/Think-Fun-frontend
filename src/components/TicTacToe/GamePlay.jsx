...
export default function GamePlay({ level, winner, setWinner }) {
  ...
  return <Board board={board} socketID={gameObj && [socket, gameObj.id_room]} setBoard={setBoard} userSign={userSign} makeTurn={makeTurn} myTurn={myTurn} winArr={winArr} resetFunc={resetBoard} vsPerson={level === 'person'} />;
}
