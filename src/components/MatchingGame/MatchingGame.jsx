...
export default function MatchingGame() {
    ...
    if (!winner) {
        return <GamePlay level={level} gameType={gameType} category={choosenCategory} setWinner={setWinner} />;
    }
    return <Result res={winner} resetBoard={() => setWinner(false)} typeGame={'matching_game'} level={gameType === 'VS Person' ? '' : level} isOnline={gameType === 'VS Person'} />;
}
